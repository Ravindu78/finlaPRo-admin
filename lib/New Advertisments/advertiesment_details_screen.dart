...
class AdvertisementDetailsScreen extends StatefulWidget {
  ...
  String phoneNo;
  String  email;
  AdvertisementDetailsScreen(this.docid,this.imgurl,this.price,this.descrip,this.varient,this.color,this.shape,this.weight,this.phoneNo,this.email,);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
       ...
       FirebaseFirestore.instance.collection('Advertisment')
                      .doc(widget.docid)
                      .update({'publish': 'true'})
